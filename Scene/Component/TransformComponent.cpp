...
auto TransformComponent::GetPosition() -> const D3DXVECTOR3
{
	...
	D3DXMatrixDecompose(&D3DXVECTOR3(), &D3DXQUATERNION(), &world_position, &world);
...
{
	D3DXVECTOR3 right;
	D3DXVec3TransformCoord(&right, &D3DXVECTOR3(1, 0, 0), &world);
...
{
	D3DXVECTOR3 up;
	D3DXVec3TransformCoord(&up, &D3DXVECTOR3(0, 1, 0), &world);
...
{
	D3DXVECTOR3 forward;
	D3DXVec3TransformCoord(&forward, &D3DXVECTOR3(0, 0, 1), &world);
